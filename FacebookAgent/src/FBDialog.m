...
- (void)strokeLines:(CGRect)rect stroke:(const CGFloat*)strokeColor {
  ...
  {
    CGPoint points[] = {CGPointMake(rect.origin.x+0.5, rect.origin.y-0.5),
      CGPointMake(rect.origin.x+rect.size.width, rect.origin.y-0.5)};
    CGContextStrokeLineSegments(context, points, 2);
  }
  {
    CGPoint points[] = {CGPointMake(rect.origin.x+0.5, rect.origin.y+rect.size.height-0.5),
      CGPointMake(rect.origin.x+rect.size.width-0.5, rect.origin.y+rect.size.height-0.5)};
    CGContextStrokeLineSegments(context, points, 2);
  }
  {
    CGPoint points[] = {CGPointMake(rect.origin.x+rect.size.width-0.5, rect.origin.y),
      CGPointMake(rect.origin.x+rect.size.width-0.5, rect.origin.y+rect.size.height)};
    CGContextStrokeLineSegments(context, points, 2);
  }
  {
    CGPoint points[] = {CGPointMake(rect.origin.x+0.5, rect.origin.y),
      CGPointMake(rect.origin.x+0.5, rect.origin.y+rect.size.height)};
    CGContextStrokeLineSegments(context, points, 2);
  }
